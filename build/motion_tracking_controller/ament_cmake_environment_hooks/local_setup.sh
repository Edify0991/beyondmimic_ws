...
: ${AMENT_CURRENT_PREFIX:="/beyondmimic_ws/install/motion_tracking_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/motion_tracking_controller/environment/library_path.sh"
